...
Magemaker offers multiple ways to deploy your models to AWS SageMaker. Choose the method that best fits your workflow.

### Interactive Deployment

When you run the `magemaker` command, you'll get an interactive menu that walks you through the deployment process:
