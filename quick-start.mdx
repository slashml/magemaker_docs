...
<Note>
The first time you run Magemaker, it will need to perform initial configuration which may take 1-2 minutes. This includes setting up cloud provider credentials and creating necessary configuration files. You'll be prompted to enter the necessary credentials.
</Note>
