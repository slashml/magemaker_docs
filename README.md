...
If this is your first time running Magemaker, you'll configure cloud provider credentials:
The tool will guide you through:

- Configuring cloud provider settings
- Entering access credentials
- Setting up region details

For AWS, It will configure the AWS client so you’re ready to start deploying models. You’ll be prompted to enter your Access Key and Secret here. You can also specify your AWS region. The default is us-east-1. You only need to change this if your SageMaker instance quota is in a different region.
Similar configuration steps apply for GCP and Azure, enabling multi-cloud deployment.
...
When you run `magemaker --cloud [aws|gcp|azure|all]` comamnd it will give you an interactive menu to deploy models. You can choose from a dropdown of models to deploy.
...
- **Query format:** "_type out a sentence like this one._"
