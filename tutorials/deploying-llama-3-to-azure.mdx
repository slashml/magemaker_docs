...
def query_azure_endpoint(endpoint_name: str, query: str):
...
if __name__ == "__main__":
    endpoint_name = "your-endpoint-id-here"
    input_text    = "What are you?"

    resp = query_azure_endpoint(endpoint_name=endpoint_name, query=input_text)
    print(resp)
```
