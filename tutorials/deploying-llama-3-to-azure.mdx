...
## Introduction
This tutorial guides you through deploying Llama 3 to Azure ML platform using Magemaker. Ensure you have followed the [installation](installation) steps before proceeding.

<Note>
  **Important:** Azure deployments currently require YAML configuration files. Interactive dropdown deployment is only available for AWS.
</Note> 
...
## Conclusion
You have successfully deployed and queried Llama 3 on Azure using Magemaker. For any questions or feedback, feel free to contact us at [support@slashml.com](mailto:support@slashml.com).
