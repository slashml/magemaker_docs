...
<Note>
We've created a detailed step-by-step guide for setting up AWS credentials with the right permissions. Check out our [AWS Setup Guide](https://docs.google.com/document/d/1NvA6uZmppsYzaOdkcgNTRl7Nb4LbpP9Koc4H_t5xNSg/edit?usp=sharing) for detailed instructions.
</Note>
...
<Note>
Follow our [GCP Setup Guide](https://docs.google.com/document/d/1NvA6uZmppsYzaOdkcgNTRl7Nb4LbpP9Koc4H_t5xNSg/edit?usp=sharing) for detailed instructions.
</Note>
...
2. Register Required Resource Providers:
   ...
   <Note>
   Registration can take up to 10 minutes. Check status with:
   ```bash
